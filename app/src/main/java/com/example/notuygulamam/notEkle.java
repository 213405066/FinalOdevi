...
public class notEkle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takvim.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            @Override
            public void onSelectedDayChange(@NonNull CalendarView view, int yil, int gun, int ay) {
    ...
    public void kaydet(View view){
        ...
        if(TextUtils.isEmpty(aktivite)){
            Toast.makeText(notEkle.this,"Lütfen Bir Aktivite Giriniz.",Toast.LENGTH_SHORT).show();
        }else{
            Not not = new Not();
            not.setId(notid);
            ...
            Toast.makeText(notEkle.this,"Notunuz Başarılı Bir Şekilde Kaydedildi.",Toast.LENGTH_SHORT).show();
